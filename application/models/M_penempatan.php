...
class M_penempatan extends CI_Model
{
    ...
    public function edit_penempatan($id_penempatan,$nama_penempatan,$gaji,$tipe_um)
    {
        if ($gaji == 0) {
            ...
            $this->db->trans_start();
            $this->db->query("UPDATE status_penempatan SET nama_penempatan='$nama_penempatan',gaji_penempatan='$gaji' , tipe_um= '$tipe_um' WHERE id_penempatan = $id_penempatan");
    ...
    public function insert_penempatan($nama_penempatan,$gaji)
    {
        if ($gaji == 0) {
            ...
            $this->db->trans_start();
            $this->db->query("INSERT INTO status_penempatan(nama_penempatan,gaji_penempatan) VALUES ('$nama_penempatan','$gaji')");
            $this->db->trans_complete();
