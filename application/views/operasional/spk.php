                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body" style="overflow-x:auto;">
                                    ...
                                    <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#exampleModal">Tambah SPK</button>
                                    <script>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-responsive">
                                                        <div class="table table-striped table-hover">
                                                            <a href="#" data-toggle="modal" data-target="#edit_data_spk<?= $id_spk ?>" class="btn btn-primary">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>
                                                            <a href="#" data-toggle="modal" data-target="#hapus_spk<?= $id_spk ?>" class="btn btn-danger">
                                                ...
                                                <div class="modal fade" id="hapus_spk<?= $id_spk ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Hapus Data SPK</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form action="<?= base_url() ?>spk/delete_spk/<?=$id_spk ?>" method="post" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <input type="hidden" name="id_spk" value="<?=$id_spk ?>" />
                                                                            <p>Apakah Anda yakin ingin menghapus SPK ini?</p>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <!-- Modal Edit Data SPK -->
                                                <div class="modal fade" id="edit_data_spk<?= $id_spk?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Edit Data SPK</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                ...
                                                                <form action="<?= base_url() ?>spk/edit_spk/<?= $id_spk ?>" method="post">
                                                                    <input type="hidden" name="id_spk" value="<?= $id_spk ?>">
                                                                    <div class="form-group">
                                                                        <label for="nama_spk">Nama SPK</label>
                                                                        <input type="text" class="form-control" id="nama_spk" name="nama_spk" value="<?= htmlspecialchars($nama_spk) ?>" required>
                                                                    </div>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?=base_url();?>spk/tambah_spk" method="POST">
                                <div class="form-group">
                                    <label for="nama_spk">Nama SPK</label>
                                    <input type="text" class="form-control" id="nama_spk"
                                        aria-describedby="nama_spk" name="nama_spk" required>
                                </div>
