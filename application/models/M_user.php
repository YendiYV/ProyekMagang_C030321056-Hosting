...
class M_user extends CI_Model
{
    ...
    {
        $hasil = $this->db->query('SELECT user.*, user_detail.*, jenis_kelamin.*,operator_level.* ,status_proyek.nama_proyek
                                    FROM user_detail
    ...
    public function update_user_detail($id, $nama_lengkap, $id_jenis_kelamin, $no_telp, $alamat, $nip, $operator_level, $proyek)
    {
        $this->db->trans_start();
    
        $this->db->query("UPDATE user_detail SET nama_lengkap='$nama_lengkap', id_jenis_kelamin='$id_jenis_kelamin', no_telp='$no_telp', alamat='$alamat', nip='$nip', jabatan='$operator_level', proyek='$proyek' WHERE id_user_detail='$id'");
    ...
    public function insert_operator($id, $username, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $alamat, $proyek, $jabatan, $tanggal_masuk)
    {
        $this->db->trans_start();
        ...
        $this->db->query("INSERT INTO user_detail(id_user_detail, nama_lengkap, id_jenis_kelamin, no_telp, alamat,proyek, nip, jabatan, tanggal_masuk ) VALUES ('$id', '$nama_lengkap', '$id_jenis_kelamin', '$no_telp', '$alamat', '$proyek', '$username', '$jabatan', '$tanggal_masuk')");
    ...
    public function update_operator($id_user, $username, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $alamat, $jabatan, $id_status_proyek, $tanggal_masuk)
    {
        $this->db->trans_start();
        ...
        $this->db->query("UPDATE user_detail SET nama_lengkap='$nama_lengkap', nip='$username' ,id_jenis_kelamin='$id_jenis_kelamin', no_telp='$no_telp', alamat='$alamat', jabatan='$jabatan', proyek='$id_status_proyek', tanggal_masuk='$tanggal_masuk' WHERE id_user_detail='$id_user'");
